...
<div class="max-w-2xl mx-auto px-2 py-2 card">
    ...
    <div class="bg-red-100 border mt-3 border-red-400 text-red-700 px-4 py-3 rounded mb-4 font-bold text-center">
        ...
        <br><strong>**Raffle is Open to Legal US Residents Only**</strong>
    </div>
    <form id="payment-form" action="{{ route('members.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="bg-red-100 border border-red-400 text-red-800 px-4 py-3 rounded relative mb-2 text-sm" role="alert">
                <strong class="font-bold">Info:</strong>
                <span class="block sm:inline">To avoid getting a card transaction rejection, please contact your credit card issuer prior to buying the tickets.</span>
                <br/><strong>NEED HELP: Please call +1 (224) 388-9122, +1 (908) 803-3523</strong>
                <br> <strong>or email: raffleqs@vhp-america.org</strong>
        </div>

        {{-- STRIPE --}}
        <div>
            <label class="block text-gray-700 font-medium mb-1">Card Details*</label>
            <div id="card-element"
...
<script src="{{ asset('js/stripe.js') }}?v={{ time() }}"></script>
@endsection